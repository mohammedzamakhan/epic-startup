...
export type CoercedEnvSchema = {
   ...
   * Signed cookies (toast, cookie-domain)  
  ...
  /**
   * **BASE_URL**  
   * Public app origin for cookie domain inference  
...
type _CoercedEnvSchema_386f3e02 = CoercedEnvSchema;
...
type _EnvSchemaAsStrings_386f3e02 = EnvSchemaAsStrings;

export type PublicCoercedEnvSchema = Readonly<Pick<CoercedEnvSchema, 'NODE_ENV' | 'BASE_URL'>>;
