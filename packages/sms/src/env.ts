...
type _CoercedEnvSchema_600197ed = CoercedEnvSchema;
...
type _EnvSchemaAsStrings_600197ed = EnvSchemaAsStrings;

export type PublicCoercedEnvSchema = Readonly<Pick<CoercedEnvSchema, 'NODE_ENV' | 'DATA_REGION' | 'TWILIO_ACCOUNT_SID' | 'TWILIO_FROM_NUMBER'>>;
