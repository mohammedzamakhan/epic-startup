...
export type CoercedEnvSchema = {
  ...
  /**
   * **DATABASE_PATH**  
   * Fallback SQLite path when DATABASE_URL is cwd-relative and missing on disk  
...
type _CoercedEnvSchema_5984bb44 = CoercedEnvSchema;
...
type _EnvSchemaAsStrings_5984bb44 = EnvSchemaAsStrings;

export type PublicCoercedEnvSchema = Readonly<Pick<CoercedEnvSchema, 'DATABASE_URL' | 'DATABASE_PATH'>>;
